...
import { Eye, EyeOff, ChefHat, Home } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur rounded-2xl p-6 text-white">
          <p className="font-display text-lg italic">
            "KitchenSync is the app I didn't know I needed. I've stopped wasting
            food entirely."
          </p>
          <p className="text-sm mt-3 opacity-80">— Sarah K.</p>
        </div>
      </div>
